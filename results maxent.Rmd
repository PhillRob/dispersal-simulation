...
sims <- Simulation(Simulation = 1,
                  Years = parameters$simulation_period,
...
write.csv(range_df, paste0("sim-r", parameters$replicates, "y", parameters$simulation_period, ".csv"))
...
mean(lagresults$Laglength,na.rm=T)
table(lagresults$Lag)
```
