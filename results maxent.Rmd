...
---
title: "BCCVL MaxEnt Distribution Model"
output:
...
1. Using the BCCVL platform, and "occurrence data" for _Cakile edentula_ in its native habitat (in USA) and the climate data "CRUclim (global), current climate (1976-2005), 30 arcmin (~50 km)" as input, predicted a species distribution map for the suitability of cakile edentula.  The output is a CSV file with the suitability probabilities (0 - 1) for different points.
