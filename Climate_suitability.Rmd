...
1. Using the [BCCVL](https://bccvl.org.au/) platform, and species occurrence data for _Cakile edentula_ in its native range (USA) and the global climate data WorldClim for 1950-2000 at ~5 km resolution we predict the potential species distribution. The output is a CSV file with the suitability probabilities (0 - 1) for different points.
